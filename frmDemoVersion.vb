Public Class frmDemoVersion
    ...
    Private Sub frmDemoVersion_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        frmJTLRechnung.setMainWindowTitle("Testversion", Me)
        ...
        If strServerInfo(0) = "ADD_AUTHCODE" Then
            ...
            Dim strServerInfo2() As String = getHTTPResponseMessage("https://api.bludau-media.de/SafeSandy/SendAuthCode.php?key=" & gbl_KeyCode & "&programID=1&programname=JTL Bridge&demoende=" & Date.Now.AddDays(15), mgetUpdaterMessage.getAuthCode, True)
        ...
        If strServerInfo.Length < 2 Then
            MessageBox.Show("Fehler beim Abrufen der Lizenzinformationen...")
        End If
    ...
    Private Sub btnProgrammRegister_Click(sender As System.Object, e As System.EventArgs) Handles btnProgrammRegister.Click
        ...
        If bRegistered = True Then
            ...
            lblMainMessage.Text = "Vielen Dank für die Registrierung Ihrer" & vbCrLf & "Version: " & gbl_KeyCode & vbCrLf & vbCrLf & "Sie können jetzt JTL Bridge uneingeschränkt nutzen"
        End If
    End Sub
