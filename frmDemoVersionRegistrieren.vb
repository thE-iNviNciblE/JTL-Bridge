Public Class frmDemoVersionRegistrieren
    ...
    Private Sub frmDemoVersionRegistrieren_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        frmJTLRechnung.setMainWindowTitle("Demoversion Registrieren", Me)
    ...
    Private Sub btnRegisterJTLBridge_Click(sender As System.Object, e As System.EventArgs) Handles btnRegisterJTLBridge.Click
        ...
        MessageBox.Show("JTL Bridge wurde erfolgreich registriert!" & vbCrLf & vbCrLf & "Sie können das Programm jetzt weiter benutzen!", "JTL Bridge Registration", MessageBoxButtons.OK, MessageBoxIcon.Information)
        bRegistered = True
        Me.Close()
    End Sub
