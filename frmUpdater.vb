Public Class frmUpdater
    ...
    Private Sub frmUpdater_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        frmJTLRechnung.setMainWindowTitle("Programm Aktuallisierung", Me)

        Dim strServerInfo() As String = getHTTPResponseMessage("https://api.bludau-media.de/SafeSandy/Update.php?key=" & gbl_KeyCode & "&programID=1&versionsnummer=" & strVersionsNummer, mgetUpdaterMessage.getProgramUpdateCheck, True)
    ...
    Private Sub btnDownload_Click(sender As System.Object, e As System.EventArgs) Handles btnDownload.Click
        ...
        If MessageBox.Show("Möchten Sie das Update von JTL Bridge jetzt installieren?", "JTL Bridge Update Installation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
